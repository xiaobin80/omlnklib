{ *************************************************************************** }
{                                                                             }
{ MS SQL2000 GENERAL connection string                                        }
{                                                                             }
...
procedure showform_MS(H:THandle);stdcall;
...
procedure TfrmMSSQL.btnCloseClick(Sender: TObject);
begin
  close;
end;
...
Begin
  ...
  Begin
    ...
    FileHead.Version := '4.2.0.1';
    FileHead.author:='xiaobinMS';
...
procedure TfrmMSSQL.FormShow(Sender: TObject);
begin
...
procedure TfrmMSSQL.btnGenClick(Sender: TObject);
var
  passSTR:WideString;
  passLen:integer;
begin
  ...
  FileData.connectstr2:='HostName';
  FileData.section3:=0;//0 true
  FileData.connectstr3:='DataBase';
  FileData.section4:=4;
  FileData.connectstr4:='DriverName';
  FileData.section5:=5;
...
procedure showform_MS(H:THandle);
begin
  Application.Handle:=H;
  try
    frmMSSQL:=TfrmMSSQL.Create(Application);
    frmMSSQL.Update;
    frmMSSQL.ShowModal;
  finally
    frmMSSQL.Free;
...
procedure TfrmMSSQL.FormClose(Sender: TObject;
